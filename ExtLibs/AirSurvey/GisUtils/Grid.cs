...
namespace MissionPlanner
{
    public class Grid
    {
        ...
        public static List<PointLatLngAlt> CreateGrid(List<PointLatLngAlt> polygon, double altitude, double distance, double spacing, double angle, PointLatLng startpos)
        {
            ...
            utmpos startposutm = new utmpos(new PointLatLngAlt(startpos));
            ...
            while (grid.Count > 0)
            {
                if (closest.p1.GetDistance(lastpnt) < closest.p2.GetDistance(lastpnt))
                {
                    ...
                    utmpos newend = newpos(closest.p2, angle, 0);
                    ans.Add(newend);
                ...
                else
                {
                    ...
                    utmpos newend = newpos(closest.p1, angle, 0);
                    ans.Add(newend);
